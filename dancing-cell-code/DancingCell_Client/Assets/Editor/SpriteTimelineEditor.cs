...
public class SpriteTimeline : ISTE
{
	...
	*/
	...
	public bool STEOnGUI(float adjust, out float bottom)
	{
		...
		// Draw our preview:
		if ((sprite is AutoSpriteBase) && sprite.States[selectedAnim].frameGUIDs.Length > 0)
		{
			...
			oldColor = GUI.contentColor;
			GUI.contentColor = ((AutoSpriteBase)sprite).color;
	...
	Rect CalcPreviewRect(Texture2D tex)
	{
		...
		switch (((AutoSpriteBase)sprite).anchor)
		{
