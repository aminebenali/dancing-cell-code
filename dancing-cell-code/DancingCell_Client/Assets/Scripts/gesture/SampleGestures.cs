...
{
	public	List<Point2D> getGestureArrow()
	{
	...
	public	List<Point2D> getGestureCaret()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureCheckMark()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureCircle()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureDelete()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureDiamond()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureLeftCurlyBrace()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureLeftSquareBracket()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureLeftToRightLine()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureLineDownDiagonal()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGesturePigtail()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureQuestionMark()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle()
	{
			List<Point2D> path = new List<Point2D>();
			path.Add(new Point2D(0,300));
			path.Add(new Point2D(0,200));
			path.Add(new Point2D(0,100));
			path.Add(new Point2D(0,0));
			path.Add(new Point2D(100,0));
			path.Add(new Point2D(200,0));
			path.Add(new Point2D(300,0));
			path.Add(new Point2D(300,100));
			path.Add(new Point2D(300,200));
			path.Add(new Point2D(300,300));
			path.Add(new Point2D(200,300));
			path.Add(new Point2D(100,300));
			
			return path;
	}
	
	public	List<Point2D> getGestureRectangle_1()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle_2()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle_3()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle_4()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(0,300));
		path.Add(new Point2D(100,300));
	...
	public	List<Point2D> getGestureRectangle_5()
	{
		List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle_6()
	{
		List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRectangle_7()
	{
		List<Point2D> path = new List<Point2D>();
	...
	public List<Point2D>  getGestureDownRight()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(0,300));
		path.Add(new Point2D(0,200));
	...
	public List<Point2D>  getGestureDownLeft()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(0,300));
		path.Add(new Point2D(0,200));
	...
	public List<Point2D>  getGestureUpLeft()
	{
		List<Point2D> path = new List<Point2D>();
		...
		path.Add(new Point2D(400,200));
		path.Add(new Point2D(400,300));
		path.Add(new Point2D(400,400));
		
		path.Add(new Point2D(300,400));
		path.Add(new Point2D(200,400));
		path.Add(new Point2D(100,400));

		return path;
	}
	
	public List<Point2D>  getGestureUpRight()
	{
		List<Point2D> path = new List<Point2D>();
    ...
    public List<Point2D> getGestureLeftUp()
    {
        List<Point2D> path = new List<Point2D>();
    ...
    public List<Point2D> getGestureLeftDown()
    {
        List<Point2D> path = new List<Point2D>();
    ...
    public List<Point2D> getGestureRightUp()
    {
        List<Point2D> path = new List<Point2D>();
    ...
    public List<Point2D> getGestureRightDown()
    {
        List<Point2D> path = new List<Point2D>();
	...
	public List<Point2D>  getGestureUp()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(0,0));
//		path.Add(new Point2D(1,26));
//		path.Add(new Point2D(0,50));
//		path.Add(new Point2D(2,75));
//		path.Add(new Point2D(0,103));
//		path.Add(new Point2D(0,125));
//		path.Add(new Point2D(-4,150));
//		path.Add(new Point2D(0,222));
//		path.Add(new Point2D(2,250));
//		path.Add(new Point2D(0,275));
		path.Add(new Point2D(0,300));
	
//		path.Add(new Point2D(103,67));
//		path.Add(new Point2D(106,73));
//		path.Add(new Point2D(106,8150));
//		path.Add(new Point2D(106,96));
//		path.Add(new Point2D(106,103));
//		path.Add(new Point2D(106,109));
//		path.Add(new Point2D(106,122));
//		path.Add(new Point2D(105,134));
	
		return path;
	}
	
	public List<Point2D>  getGestureDown()
	{
		List<Point2D> path = new List<Point2D>();
...
//		path.Add(new Point2D(1,26));
	...
	public List<Point2D>  getGestureLeft()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(200,0));
		path.Add(new Point2D(0,0));
	...
	public List<Point2D>  getGestureRight()
	{
		List<Point2D> path = new List<Point2D>();
		path.Add(new Point2D(0,0));
		path.Add(new Point2D(200,0));
	...
	public	List<Point2D> getGestureRightSquareBracket()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRightCurlyBrace()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRightToLeftLine()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureRightToLeftLine2()
	{
			List<Point2D> path = new List<Point2D>();
			path.Add(new Point2D(200,160));
	...
	public	List<Point2D> getGestureRightToLeftSlashDown()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureSpiral()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureStar()
	{
			List<Point2D> path = new List<Point2D>();
	...
	public	List<Point2D> getGestureTriangle()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
			...
			path.Add(new Point2D(50,50/Mathf.Tan((30.0f/180.0f)*Mathf.PI)));
				
			path.Add(new Point2D(0,0));
			return path;
	}
	
	public	List<Point2D> getGestureTriangle_1()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
	...
	public	List<Point2D> getGestureTriangle_2()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
	...
	public	List<Point2D> getGestureTriangle_3()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
	...
	public	List<Point2D> getGestureTriangle_4()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
	...
	public	List<Point2D> getGestureTriangle_5()
	{
			//Debug.LogError(" Mathf.Tan(30):  "+Mathf.Tan((30.0f/180.0f)*Mathf.PI));
    ...
    public List<Point2D> getGestureLighting()
    {
        List<Point2D> path = new List<Point2D>();

        path.Add(new Point2D(418.5f, 612.1f));
        path.Add(new Point2D(336.8f, 546.8f));
        path.Add(new Point2D(245.4f, 465.0f));
        path.Add(new Point2D(177.8f, 392.2f));
        path.Add(new Point2D(292.5f, 403.6f));
        path.Add(new Point2D(392.8f, 414.2f));
        path.Add(new Point2D(479.0f, 423.6f));
        path.Add(new Point2D(383.3f, 323.7f));
